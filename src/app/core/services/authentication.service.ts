...
import { AythenticationResponse } from '../models/aythentication-response';
...
export class AuthenticationService extends BaseService {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  authenticate$Response(params: Authenticate$Params, context?: HttpContext): Observable<StrictHttpResponse<AythenticationResponse>> {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  authenticate(params: Authenticate$Params, context?: HttpContext): Observable<AythenticationResponse> {
    return this.authenticate$Response(params, context).pipe(
      map((r: StrictHttpResponse<AythenticationResponse>): AythenticationResponse => r.body)
    );
  }
